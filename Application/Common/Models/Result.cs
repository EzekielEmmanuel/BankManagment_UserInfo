...
public class Result
{
    ...
    {
        return new Result(false, new string[] { error.Message });
    }
...
public class Result<TValue> : Result
{
    ...
    {
        return new Result<TValue>(false, new string[] { error.Message });
    }
    ...
    {
        return new Result<TValue>(false, new string[] { error });
    }
